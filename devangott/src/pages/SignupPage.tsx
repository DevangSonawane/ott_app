...
export function SignupPage({ onProfileClick }: SignupPageProps) {
          ...
          <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-[#14141f] via-[#11131a] to-[#0d0f14] shadow-[0_40px_120px_rgba(0,0,0,0.6)]">
            ...
            <div className="relative px-6 sm:px-10 py-8">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h1 className="text-2xl sm:text-3xl font-semibold text-white">Sign up or login to continue</h1>
                  <p className="text-white/50 mt-2">Scan QR code or enter phone number to sign up</p>
                </div>
              ...
              <div className="mt-8 grid md:grid-cols-[1fr_auto_1fr] gap-8 items-center">
                ...
                <div>
                  <div className="inline-flex items-center gap-2 p-1 bg-white/5 rounded-full mb-4">
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                        signupMethod === 'email' ? 'bg-white text-black' : 'text-white/70 hover:text-white'
                      }`}
                    >
                      Email
                    </button>
                    <button
                      ...
                      className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                        signupMethod === 'phone' ? 'bg-white text-black' : 'text-white/70 hover:text-white'
                      }`}
                    >
                      Phone
                    </button>
                  ...
                  <p className="text-white/50 text-sm mt-4">
                    ...
                    <Link to="/login" className="text-[#7c3aed] hover:text-[#8b5cf6]">
                      Login
                    </Link>
                  </p>
                </div>
